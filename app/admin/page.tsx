        ...
        {activeTab === 'stats' && !loading && stats && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-2">
                  {stats.total > 0 ? ((stats.pending_validation / stats.total) * 100).toFixed(1) : 0}% del total
                </p>
                  </div>
            </div>
                  ...
                  <table className="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tbody className="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                      {stats.history.map((event, index) => (
                        <tr key={index} className="hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              <div className="flex-shrink-0 h-8 w-8 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mr-3">
